...
export const postPipelineProfiles: PostPipelineProfile[] = [
  ...
  { id: "hlg-hlg", name: "HLG → HLG HDR", input: "Rec.2100 HLG (Scene) / BT.2020", project: "DaVinci YRGB Color Managed · 自定义 · HDR 1000 nits", timeline: "DaVinci Wide Gamut / Intermediate", output: "Rec.2100 HLG · BT.2020", render: "H.265 Main10 · 4K · 跟随素材 29.97p / 59.94p · 10-bit · Rec.2020 / HLG", audio: "AAC 48 kHz Stereo · 320 kb/s", checks: ["将MR3素材明确标记为Rec.2100 HLG (Scene)", "时间线使用DaVinci Wide Gamut / Intermediate，输出Rec.2100 HLG", "时间线、播放与输出帧率必须跟随原始素材", "MediaInfo核验10-bit、BT.2020与HLG标签", "YouTube显示2160p HDR后再公开"], warnings: ["不要套用MR1/MR2的S-Log3输入设置", "RCM链路中不要重复添加HLG输入/输出CST或Sony LUT", "除非明确需要PQ母版，否则MR3优先保持HLG到HLG"] },
