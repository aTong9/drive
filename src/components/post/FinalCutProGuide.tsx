...
export function FinalCutProGuide() {
  const [topic, setTopic] = useSessionState("fcp-topic", "全部");
  const [query, setQuery] = useSessionState("fcp-query", "");
  const [openId, setOpenId] = useSessionState<string>("fcp-openId", 
